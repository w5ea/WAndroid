...
public class SFragmentTabHost {
	...
	public SFragmentTabHost(Context context, FragmentManager manager,int containerId ) {
		mContext = context;
...
//        	Toast.makeText(mContext, ""+mCurrentTabIndex+"i="+index, 0).show();
            return;
        }
